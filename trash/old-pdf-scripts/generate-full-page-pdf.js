...
// Custom renderer to preserve emojis and colors
...
async function generatePDF() {
    ...
    for (const file of files) {
        ...
        content = content.replace(/❄️❄️/g, '<span class="emoji">❄️❄️</span>');
    ...
    const pdfBuffer = await page.pdf({
        path: path.join(outputDir, 'ebook-full-page.pdf'),
    ...
    console.log(`Output: ${path.join(outputDir, 'ebook-full-page.pdf')}`);
}
