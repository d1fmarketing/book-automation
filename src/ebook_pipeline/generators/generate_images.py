...
class ImageGenerator:
    ...
    def generate_image(self, prompt_data):
        ...
        try:
            if self.provider == "openai":
                # Use OpenAI/Sora
                console.print("    [cyan]Using Sora (gpt-image-1)[/cyan]")
    ...
    def enhance_image(self, image_path):
        ...
        try:
            ...
            console.print("    [blue]→ Enhancing image...[/blue]")
    ...
    def apply_text_overlay(self, image_path, text, color="#FFFFFF"):
        ...
        try:
            ...
            console.print("    [green]✓ Text overlay applied[/green]")
            logger.info(f"Applied text overlay to {image_path.name}: {text}")

            return True

        except ImportError:
            console.print("    [yellow]⚠ Pillow not installed, skipping text overlay[/yellow]")
